...
local bgSound = audio.loadSound("Sounds/level1Music.wav", {channel = 1, loops = -1})
local bgSoundChannel
...
local function PositionAnswers()
    ...
    if (randomPosition == 1) then
        ...
        --alternateAnswerBox3
        alternateAnswerBox3.y = display.contentHeight * 0.25
    ...
    elseif (randomPosition == 2) then
        ...
        answerbox.y = display.contentHeight * 0.25
    ...
    -- random position 4
     elseif (randomPosition == 4) then
        ...
        --alternateAnswerBox2
        alternateAnswerBox2.y = display.contentHeight * 0.25
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        bgSoundChannel = audio.play(bgSound)
        RestartLevel1()
